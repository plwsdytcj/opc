...
const resources: Record<Language, Dict> = {
  en: {
    ...
    "common.http.get": "GET {value}",
    "common.http.post": "POST {value}",
    ...
    "invite.joinSubmitted.requestId": "Request ID",
    ...
    "settings.invites.header": "You're invited to join a Paperclip organization.",
    "settings.invites.urlsIntro": "The URLs you should try are:",
    "settings.invites.connectivity.header": "Connectivity guidance:",
    "settings.invites.connectivity.note1": "If you are running on a different machine than Paperclip, Paperclip must be reachable at one of the hostnames used above.",
    "settings.invites.connectivity.verify": "Verify the hostname works from your runtime with: GET <base-url>/api/health",
    "settings.invites.agentNameNote": "For your \"agentName\", just use your own agent name and send it directly.",
    "settings.invites.gatewayNote": "You also need to send a gateway URL that Paperclip can access. Check your config and include that URL.",
    ...
    "design.sampleApp": "Sample App",
    "design.issueList": "Issue List",
    "design.card.description": "Card description with supporting text.",
    "design.card.body": "Card content goes here. This is the main body area.",
    "design.action": "Action",
    "design.tabs.overview": "Overview",
    "design.tabs.runs": "Runs",
    "design.tabs.config": "Config",
    "design.tabContent.overview": "Overview tab content.",
    "design.tabContent.runs": "Runs tab content.",
    "design.tabContent.config": "Config tab content.",
    "design.tabContent.costs": "Costs tab content.",
    "design.tabs.summary": "Summary",
    "design.tabs.details": "Details",
    "design.tabs.comments": "Comments",
    "design.tabContent.summary": "Summary content with underline tabs.",
    "design.tabContent.details": "Details content.",
    "design.tabContent.comments": "Comments content.",
    "design.resetFilters": "Reset filters",
    "design.tooltip.hoverMe": "Hover me",
    "design.tooltip.sample": "This is a tooltip",
    "design.dialog.open": "Open Dialog",
    "design.dialog.title": "Dialog Title",
    "design.dialog.sampleText": "This is a sample dialog showing the standard layout with header, content, and footer.",
    "design.empty.message": "No items to show. Create your first one to get started.",
    "design.empty.action": "Create Item",
    "design.budget.under": "Under budget ({pct}%)",
    "design.budget.warning": "Warning ({pct}%)",
    "design.budget.over": "Over budget ({pct}%)",
    "design.view.list": "List",
    "design.view.org": "Org",
    
    // DesignGuide extras
    "design.section.select": "Select",
    "design.select.smallTrigger": "Small trigger",
    "design.section.dropdown": "Dropdown Menu",
    "design.dropdown.quickActions": "Quick Actions",
    "design.dropdown.markDone": "Mark as done",
    "design.dropdown.openDocs": "Open docs",
    "design.dropdown.watchIssue": "Watch issue",
    "design.dropdown.deleteIssue": "Delete issue",
    "design.section.popover": "Popover",
    "design.popover.statusLine": "Last run succeeded 24s ago. Next timer run in 9m.",
    "design.section.collapsible": "Collapsible",
    "design.advancedFilters": "advanced filters",
    "design.section.badges": "Badges",
    "design.badges.variants": "Variants",
    "design.section.statusSystem": "Status System",
    "design.status.badgeAll": "StatusBadge (all statuses)",
    "design.status.iconInteractive": "StatusIcon (interactive)",
    "design.status.priorityInteractive": "PriorityIcon (interactive)",
    "design.status.agentDots": "Agent status dots",
    "design.status.runBadges": "Run invocation badges",
    "design.agentStatus.running": "running",
    "design.agentStatus.active": "active",
    "design.agentStatus.paused": "paused",
    "design.agentStatus.error": "error",
    "design.agentStatus.archived": "archived",
    "design.runBadge.timer": "timer",
    "design.runBadge.assignment": "assignment",
    "design.runBadge.on_demand": "on demand",
    "design.runBadge.automation": "automation",
    
    // Form elements
    
    "design.form.input": "Input",
    "design.form.textarea": "Textarea",
    "design.form.checkboxLabel": "Checkbox & Label",
    "design.form.inlineEditor": "Inline Editor",
    "design.check.checked": "Checked",
    "design.check.unchecked": "Unchecked",
    "design.check.disabled": "Disabled",
    "design.section.formElements": "Form Elements",
    "design.buttons.variants": "Variants",
    "design.buttons.sizes": "Sizes",
    "design.buttons.iconButtons": "Icon buttons",
    "design.buttons.withIcons": "With icons",
    "design.buttons.states": "States",
    "design.status.clickToChange": "Click the icon to change status (current: {status})",
    "design.priority.clickToChange": "Click the icon to change (current: {priority})",
    "design.costTable.model": "Model",
    "design.costTable.tokens": "Tokens",
    "design.costTable.cost": "Cost",
    "design.costTable.total": "Total",
  ...
  zh: {
    ...
    "settings.invites.header": "你受邀加入一个 Paperclip 组织。",
    "settings.invites.urlsIntro": "请尝试以下 URL：",
    "settings.invites.connectivity.header": "连通性指引：",
    "settings.invites.connectivity.note1": "如果你的运行环境与 Paperclip 不在同一台机器上，Paperclip 必须可以通过上述主机名之一被访问。",
    "settings.invites.connectivity.verify": "请在运行环境中验证该主机名：GET <base-url>/api/health",
    // Design guide header
    "design.title": "设计指南",
    "design.subtitle": "Paperclip 中使用的全部组件、样式与模式。",
    "design.section.coverage": "组件覆盖",
    "design.coverage.note": "当有新的基础组件或模式发布时，请更新本页面。",
    "design.uiPrimitives": "基础组件",
    "design.appComponents": "应用组件",

    // Design guide sections
    "design.section.colors": "颜色",
    "design.colors.core": "核心",
    "design.colors.sidebar": "侧边栏",
    "design.colors.chart": "图表",
    "design.color.background": "背景",
    "design.color.foreground": "前景",
    "design.color.card": "卡片",
    "design.color.primary": "主色",
    "design.color.primaryForeground": "主色前景",
    "design.color.secondary": "次色",
    "design.color.muted": "弱化",
    "design.color.mutedForeground": "弱化前景",
    "design.color.accent": "强调",
    "design.color.destructive": "危险",
    "design.color.border": "边框",
    "design.color.ring": "焦点环",
    "design.color.sidebar": "侧边栏",
    "design.color.sidebarBorder": "侧边栏边框",
    "design.color.chart1": "图表 1",
    "design.color.chart2": "图表 2",
    "design.color.chart3": "图表 3",
    "design.color.chart4": "图表 4",
    "design.color.chart5": "图表 5",

    "design.section.typography": "排版",
    "design.sectionHeadingMeta": "区段标题 — text-sm font-semibold uppercase tracking-wide",
    "design.mutedDescriptionMeta": "弱化描述 — text-sm text-muted-foreground",
    "design.tinyLabelMeta": "微型标签 — text-xs text-muted-foreground",
    "design.monoIdentifierMeta": "等宽标识 — text-sm font-mono text-muted-foreground",
    "design.pageTitle": "页面标题",
    "design.sectionTitle": "分区标题",
    "design.cardTitle": "卡片标题",
    "design.cardTitleAlt": "卡片标题（变体）",
    "design.bodyText": "正文文本",
    "design.largeStat": "42,981",
    "design.codeText": "const x = 123;",

    "design.section.radius": "圆角",
    "design.section.buttons": "按钮",
    "design.section.sheet": "侧边面板",
    "design.commentsHeader": "评论（{count}）",

    // Buttons & badges
    "design.button.default": "默认",
    "design.button.secondary": "次要",
    "design.button.outline": "描边",
    "design.button.ghost": "幽灵",
    "design.button.destructive": "危险",
    "design.button.link": "链接",
    "design.button.xs": "极小",
    "design.button.sm": "小",
    "design.button.lg": "大",
    "design.button.newIssue": "新建问题",
    "design.button.upload": "上传",
    "design.button.add": "添加",
    "design.button.disabled": "禁用",
    "design.button.disabledOutline": "禁用（描边）",
    "design.button.email": "邮件",
    "design.badge.default": "默认",
    "design.badge.secondary": "次要",
    "design.badge.outline": "描边",
    "design.badge.destructive": "危险",
    "design.badge.ghost": "幽灵",

    // Popover, sheet, filters
    "design.openPopover": "打开气泡卡片",
    "design.agentHeartbeat": "智能体心跳",
    "design.wakeNow": "立即唤醒",
    "design.owner": "负责人",
    "design.openSidePanel": "打开侧边面板",
    "design.issueProperties": "问题属性",
    "design.editMetadataHint": "在侧边面板中编辑元数据。",

    "design.section.scrollArea": "滚动区域",
    "design.scroll.item": "心跳运行 #{n}：已成功完成",

    "design.section.command": "命令面板（CMDK）",
    "design.cmdk.pages": "页面",
    "design.cmdk.actions": "操作",
    "design.cmdk.openPalette": "打开命令面板",

    "design.section.breadcrumb": "面包屑",
    "design.section.cards": "卡片",
    "design.metric.cards": "指标卡片",
    "design.metric.activeAgents": "活跃智能体",
    "design.metric.openIssues": "未解决问题数",
    "design.metric.monthlyCost": "月度成本",
    "design.metric.uptime": "在线率",
    "design.metric.underBudget": "低于预算",
    "design.metric.plusThisWeek": "本周 +{n}",

    "design.section.tabs": "标签页",
    "design.section.entityRows": "实体行",
    "design.section.filterBar": "筛选栏",
    "design.section.avatars": "头像",
    "design.section.identity": "身份组件",
    "design.section.tooltips": "提示",
    "design.section.dialog": "对话框",
    "design.section.emptyState": "空状态",
    "design.section.progressBars": "进度条（预算）",
    "design.section.logViewer": "日志查看器",
    "design.section.navigation": "导航模式",
    "design.section.viewToggle": "视图切换",
    "design.section.groupedList": "分组列表（问题模式）",
    "design.section.commentThread": "评论线程模式",
    "design.section.costTable": "成本表模式",

    // Design guide samples
    "design.sample.task1": "构建智能体心跳系统",
    "design.sample.task2": "添加成本看板",
    "design.sample.comment1": "开始处理认证模块，需要配置 API 密钥。",
    "design.sample.comment2": "API 密钥已添加至保管库，请继续。",
    ...
    "common.http.get": "GET {value}",
    "common.http.post": "POST {value}",
    "design.sampleApp": "示例应用",
    "design.issueList": "问题列表",
    "design.card.description": "带有支持性文本的卡片描述。",
    "design.card.body": "卡片内容在此。这是主体区域。",
    "design.action": "操作",
    "design.tabs.overview": "总览",
    "design.tabs.runs": "运行",
    "design.tabs.config": "配置",
    "design.tabContent.overview": "总览选项卡内容。",
    "design.tabContent.runs": "运行选项卡内容。",
    "design.tabContent.config": "配置选项卡内容。",
    "design.tabContent.costs": "成本选项卡内容。",
    "design.tabs.summary": "摘要",
    "design.tabs.details": "详情",
    "design.tabs.comments": "评论",
    "design.tabContent.summary": "带下划线标签的摘要内容。",
    "design.tabContent.details": "详情内容。",
    "design.tabContent.comments": "评论内容。",
    "design.resetFilters": "重置筛选",
    "design.tooltip.hoverMe": "悬停我",
    "design.tooltip.sample": "这是一个工具提示",
    "design.dialog.open": "打开对话框",
    "design.dialog.title": "对话框标题",
    "design.dialog.sampleText": "这是一个示例对话框，展示包含头部、内容和底部的标准布局。",
    "design.empty.message": "暂无可显示项。创建第一个项目开始使用。",
    "design.empty.action": "创建项目",
    "design.budget.under": "预算内（{pct}%）",
    "design.budget.warning": "警告（{pct}%）",
    "design.budget.over": "超预算（{pct}%）",
    "design.view.list": "列表",
    "design.view.org": "组织",
    
    // DesignGuide extras
    "design.section.select": "选择框",
    "design.select.smallTrigger": "小型触发器",
    "design.section.dropdown": "下拉菜单",
    "design.dropdown.quickActions": "快捷操作",
    "design.dropdown.markDone": "标记为完成",
    "design.dropdown.openDocs": "打开文档",
    "design.dropdown.watchIssue": "关注问题",
    "design.dropdown.deleteIssue": "删除问题",
    "design.section.popover": "气泡卡片",
    "design.popover.statusLine": "上次运行于 24 秒前成功。下次定时运行在 9 分钟后。",
    "design.section.collapsible": "可折叠区块",
    "design.advancedFilters": "高级筛选",
    "design.section.badges": "徽章",
    "design.badges.variants": "变体",
    "design.section.statusSystem": "状态系统",
    "design.status.badgeAll": "StatusBadge（全部状态）",
    "design.status.iconInteractive": "StatusIcon（可交互）",
    "design.status.priorityInteractive": "PriorityIcon（可交互）",
    "design.status.agentDots": "智能体状态圆点",
    "design.status.runBadges": "运行触发徽章",
    "design.agentStatus.running": "运行中",
    "design.agentStatus.active": "活跃",
    "design.agentStatus.paused": "暂停",
    "design.agentStatus.error": "错误",
    "design.agentStatus.archived": "已归档",
    "design.runBadge.timer": "定时器",
    "design.runBadge.assignment": "指派",
    "design.runBadge.on_demand": "按需",
    "design.runBadge.automation": "自动化",
    
    // Form elements
    
    "design.form.input": "输入框",
    "design.form.textarea": "多行输入",
    "design.form.checkboxLabel": "复选框与标签",
    "design.form.inlineEditor": "行内编辑器",
    "design.check.checked": "已勾选",
    "design.check.unchecked": "未勾选",
    "design.check.disabled": "已禁用",
    "design.section.formElements": "表单元素",
    "design.buttons.variants": "变体",
    "design.buttons.sizes": "尺寸",
    "design.buttons.iconButtons": "图标按钮",
    "design.buttons.withIcons": "带图标",
    "design.buttons.states": "状态",
    "design.status.clickToChange": "点击图标以更改状态（当前：{status}）",
    "design.priority.clickToChange": "点击图标以更改优先级（当前：{priority}）",
    "design.costTable.model": "模型",
    "design.costTable.tokens": "Token",
    "design.costTable.cost": "成本",
    "design.costTable.total": "合计",
    "invite.joinSubmitted.requestId": "请求 ID",
    "settings.invites.agentNameNote": "“agentName” 请使用你自己的智能体名称并直接发送。",
    "settings.invites.gatewayNote": "你还需要提供一个 Paperclip 可访问的网关 URL。请检查你的配置并包含该 URL。",
    "projects.workspace.local.placeholder": "/absolute/path/to/workspace",
